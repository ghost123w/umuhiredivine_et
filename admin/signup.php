...
<body class="login-wrapper" style="background: radial-gradient(circle, #ff3503 0%, #0a0a0a 70%);">
    <div class="login-card" style="border: 2px solid var(--primary-color); box-shadow: 0 0 30px var(--primary-glow);">
        ...
        <h2 style="color: var(--primary-color); text-transform: uppercase; letter-spacing: 2px;">Admin Sign Up</h2>
        ...
        <div style="text-align: center; margin-top: 20px; font-size: 0.9rem;">
            Already have an account? <a href="login.php" style="color: var(--primary-color); text-decoration: none; font-weight: 600;">Login</a>
        </div>
