    ...
    <header class="layout-header">
        <div class="layout-header-content">
            ...
            <nav class="admin-nav-minimal">
                ...
                <a href="dashboard.php?view=manage">Features</a>
    ...
    <div class="aura-container">
        ...
        <?php if ($view == 'overview'): ?>
            <div class="aura-card" style="text-align: center; background: linear-gradient(135deg, rgba(255,53,3,0.1) 0%, rgba(100,50,255,0.1) 100%);">
                <h2 class="aura-title pulse-glow" style="margin-bottom: 10px;">Atelier Dashboard</h2>
                <p style="opacity: 0.6; margin-bottom: 30px;">Managing the <?php echo htmlspecialchars(SITE_NAME); ?> Experience</p>
        ...
        <?php if ($view == 'manage'): ?>
            ...
            <?php if (empty($sections)): ?>
                <div class="aura-card" style="text-align: center; padding: 60px;">
                    <p style="opacity: 0.5;">No points found</p>
                </div>
            <?php endif; ?>
