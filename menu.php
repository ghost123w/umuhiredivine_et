...
// Featured image for the first scroll (Hero)
...
<head>
    ...
    <style>
        ...
        .transparent-scroll {
            ...
            pointer-events: none; /* Allow interaction with fixed elements if needed, though usually not for spacer */
        }
...
<body class="menu-page">
    ...
    <main class="layout-main">
        ...
        <!-- Third Scroll: Menu Items on solid background -->
            ...
            <div class="container menu-grid-luxury">
                ...
                foreach ($products as $product):
                    if ($current_cat !== $product['category']):
                        ...
                        echo "<h2 class='category-header'>" . htmlspecialchars($current_cat) . "</h2>";
                    endif;
                ?>
