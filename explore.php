...
<main class="layout-main explore-layout">
    <section id="section-1" class="explore-section explore-hero-section">
        <div class="explore-hero-content">
            <p class="explore-subtext">JOURNEY THROUGH RWANDAN HERITAGE</p>
            <h1 class="luxury-heading-v3">EXPLORE</h1>
        </div>
    </section>
