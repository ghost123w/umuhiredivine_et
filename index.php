...
$stmt->execute();
$sec3_title = $stmt->fetchColumn() ?: 'ABOUT US';
    ...
    <div class="scroll-container">
        ...
        <section class="scroll-section sec-3" style="padding: 0; overflow: hidden;">
            <div class="sec-3-layout">
                ...
                <div class="sec-3-col-left">
                    <div class="sec-3-text-wrapper">
                        ...
                        <h2 class="sec-3-title">
                            <img src="images/image.png" alt="<?php echo htmlspecialchars($sec3_title); ?>" class="sec-3-title-img">
                        </h2>
                ...
                <!-- Right Column (Featuring a half-height image) -->
                <div class="sec-3-col-right">
                    <img src="<?php echo htmlspecialchars($sec3_img2); ?>" alt="Private Collection Half Height Image" class="sec-3-half-img">
                </div>
            </div>
        </section>
